...
gameTitle.prototype = {
  	create: function(){
		...
		var tutoButton = this.game.add.button(512,900,"tutoButton",this.tutoButton,this,1,0);
		tutoButton.anchor.setTo(0.5,0.5);
		game.add.tween(tutoButton).to({ y: 564 },2000, Phaser.Easing.Elastic.InOut, true, 0);
