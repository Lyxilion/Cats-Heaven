...
preload.prototype = {
	preload: function(){ 
		...
		this.game.load.spritesheet('player', 'assets/img/player.png',68,48);
		this.game.load.spritesheet('boss', 'assets/img/boss.png',76,76);
		this.game.load.spritesheet('sound', 'assets/img/sound.png',20,23);
		this.game.load.spritesheet('play', 'assets/img/play.png',200,79);
		this.game.load.spritesheet('tutoButton', 'assets/img/tutoButton.png',321,66);
		...
		this.game.load.audio('introSound', 'assets/sound/introSound.wav');
	},
  	create: function(){
